...
class MusicCache:
    ...
    def get_stats(self) -> dict:
        ...
        return {
            ...
            'oldest_entry': min((entry['cached_at'] for entry in self.cache.values()), default=None),
            'newest_entry': max((entry['cached_at'] for entry in self.cache.values()), default=None)
        }